...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ==========================================
    // 4. FETCH ENROLLED COURSES, PROGRESS & SCHEDULE
    // ==========================================
    ...
    if (enrolledCoursesContainer) {
        ...
        if (error) {
            ...
            enrolledCoursesContainer.innerHTML = enrollments.map(enrollment => {
                ...
                const classDay = enrollment.class_day || 'Not scheduled';
                const classTime = enrollment.class_time || '';
                ...
                return `
                    <div class="mb-6 last:mb-0 bg-ivory p-4 rounded-xl border border-muted/10">
                        ...
                        <div class="flex flex-col gap-2 mt-2 text-sm">
                            ...
                            <div class="flex items-center">
                                <svg class="w-4 h-4 text-primary mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                <span class="text-muted">Class Schedule: <span class="text-text font-medium">${classDay} ${classTime}</span></span>
                            </div>
                        </div>
                    </div>
                `;
